      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-3 gap-10 sm:gap-8 mb-10">
          ...
          <div>
            ...
            <p className="text-white/40 text-sm leading-relaxed max-w-xs">
              Training and consulting for private practices. Helping practice owners grow revenue and build stronger&nbsp;teams.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-6">
              {/* Facebook */}
              <a
                href="https://web.facebook.com/survivalstrategiesinc"
                target="_blank"
              ...
              {/* X (Twitter) */}
              <a
                href="https://x.com/OfficialSSInc"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="X"
                className="text-white/40 hover:text-white transition-colors"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/survivalstrategiesinc/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/company/940754"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="text-white/40 hover:text-white transition-colors"
        ...
        <div className="border-t border-white/10 pt-6">
          <p className="text-white/30 text-xs text-center">
            &copy; {currentYear} Survival Strategies, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
